...
@click.option('--subject', prompt=True, confirmation_prompt=True, help='The subject to teach.')
@click.option('--classes', prompt=True, confirmation_prompt=True, help='Classes to teach.')
